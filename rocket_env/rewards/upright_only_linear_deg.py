...
class RocketReward:
    ...
    def _calculate_upright_reward(self, state):
        ...
        return -self.W_UPRIGHT * tilt_deg
    ...
    def _calculate_velocity_reward(self, state):
        ...
        vel_z = state['vel'][2]
        speed_to_penalize = speed_to_penalize = np.maximum(0.0, -vel_z)
        return self.W_VELOCITY * speed_to_penalize
